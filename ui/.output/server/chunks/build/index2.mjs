...
import { i as Un, j as L, o as Ln, p as te, s as ts } from '../nitro/nitro.mjs';
...
function _() {
  var _a;
  const r = l(() => Ln(), { deferStream: true }), n = l(() => K(), { deferStream: true });
  return console.log({ branches: n() }), ssr(q, ssrHydrationKey(), escape((_a = r()) == null ? void 0 : _a.username), escape(createComponent(For, { get each() {
    return n();
  }, children: (t) => ssr(F, ssrHydrationKey(), escape(t.name)) })), ssrAttribute("action", escape(Un, true), false));
}
