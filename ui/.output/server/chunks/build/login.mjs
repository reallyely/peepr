...
import { b as Ln, U as Un } from '../nitro/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
function w(a) {
  var _a;
  const r = Ln(Un);
  return ssr(d, ssrHydrationKey(), ssrAttribute("action", escape(Un, true), false), ssrAttribute("value", (_a = escape(a.params.redirectTo, true)) != null ? _a : "/", false), escape(createComponent(Show, { get when() {
    return r.result;
  }, get children() {
