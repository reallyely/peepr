      ...
      <div class="main-container">
        ...
        <div class="card">
          ...
          <div class="contact-item">
            ...
            <div class="status-indicator" style="background-color: var(--status-online);" />
          </div>

          <div class="contact-item">
            <div class="avatar" style="background: var(--gradient-secondary);">
              VH
            </div>
            <div class="contact-info">
            ...
            <div class="status-indicator" style="background-color: var(--status-away);" />
          </div>

          <div class="contact-item">
            <div class="avatar" style="background: var(--gradient-special);">
              CJ
            </div>
            <div class="contact-info">
            ...
            <div class="status-indicator" style="background-color: var(--status-offline);" />
          </div>
        </div>

        <div class="flex gap-4" style="margin-top: var(--spacing-lg);">
          <button class="button" style="background: var(--gradient-primary);">
            Primary Action
          </button>
          <button class="button" style="background: var(--gradient-secondary);">
            Secondary Action
          </button>
          <button class="button" style="background: var(--gradient-success);">
            Success Action
          </button>
        </div>
      </div>
