import { Duration, StatisticalDistribution } from "@peepr/core"

export function calculateDurationStatisticalDistribution(durations: Duration[]): StatisticalDistribution {
  if (!durations.length) {
